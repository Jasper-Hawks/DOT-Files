...
#define PATH(name)                      "/home/jasper/git/DOT-Files/dwmblocks/blocks/"name
...
/*      pathu                           pathc                           interval        signal */
        { PATH("pack.sh"),          NULL,                           100,             5},
        { PATH("ram.sh"),          NULL,                           1,             4},
        { PATH("cmus.sh"),          NULL,                           1,             3},
        { PATH("jasperVolume.sh"),          NULL,                           1,             2},
